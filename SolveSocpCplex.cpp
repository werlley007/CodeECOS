...
//		cout << " size sequence " << sizeProblem << endl;
		return sizeProblem;
	}
...
//		SOCP.setParam( IloCplex::NumericalEmphasis, true );
//		barrier convergence parameter
...
//		solve model
		SOCP.solve();
//		SOCP.exportModel( "SOCP_CPLEX.lp" );
		SOCP.getStatus();
//		cout << SOCP.getStatus() << endl;
...
//getchar();
//		IloRange isol_1 = ( w[ sequence[ 0 ] ] - x[ sequence[ sizeProblem - 1 ] ] + x[ sequence[ 0 ] ] == 0 );
//		char c[100];
//		sprintf(c, "c%d", 0);
//		isol_1.setName(c);
//		model.add( isol_1 );
...
//			IloRange r = ( w[ sequence[ j ] ] - x[ sequence[ j - 1 ] ] + x[ sequence[ j ] ] == 0 );
//			char c[100];
//			sprintf(c, "c%d", j);
//			r.setName(c);
//			model.add(r);
//		}
//	
////		separating last constraint
//		IloRange isol_2 = ( u[ sequence[ 0 ] ] - y[ sequence[ sizeProblem - 1 ] ] + y[ sequence[ 0 ] ] == 0 );
//		char c2[100];
...
//	
//		for (int j = 1; j < sizeProblem; j++) {
//			IloRange r = ( u[ sequence[ j ] ] - y[ sequence[ j - 1 ] ] + y[ sequence[ j ] ] == 0 );
//			char c[100];
